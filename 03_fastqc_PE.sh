...
#SBATCH --output=bin/OUT/fastqc/%A_%a-%J.o
#SBATCH --error=bin/ERR/fastqc/%A_%a-%J.e
...
mkdir -p ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/fastqc
...
fastqc -o ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/fastqc/ ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/trimmomatic/${sampleNames[$SLURM_ARRAY_TASK_ID]}.trimmed_1.fastq.gz ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/trimmomatic/${sampleNames[$SLURM_ARRAY_TASK_ID]}.trimmed_2.fastq.gz
