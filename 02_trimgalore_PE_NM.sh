...
#SBATCH --output=bin/OUT/trimgalore/%A_%a-%J.o
#SBATCH --error=bin/ERR/trimgalore/%A_%a-%J.e
...
mkdir -p ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/trimgalore

module load cutadapt/3.2

./../TrimGalore-0.6.6/trim_galore -o ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/trimgalore --paired ${myDir}/input/${sampleNames[$SLURM_ARRAY_TASK_ID]}_1.fastq.gz ${myDir}/input/${sampleNames[$SLURM_ARRAY_TASK_ID]}_2.fastq.gz
