...
mkdir -p ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/bamtools_tg

module load bamtools/170119

bamtools stats -in ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/markduplicates_tg/${sampleNames[$SLURM_ARRAY_TASK_ID]}.markdup.bam > ${myDir}/output/${sampleNames[$SLURM_ARRAY_TASK_ID]}/bamtools_tg/${sampleNames[$SLURM_ARRAY_TASK_ID]}.markdup.dupstats.txt
